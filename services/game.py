...
from services.dealer import BlackjackDealer as Dealer
from services.player import BlackjackPlayer as Player
from services.judger import BlackjackJudger as Judger
...
class BlackjackGame(object):
    ...
    def step(self, action):
        ...
        return {'id': self.get_player_id(), 'state': next_state, 'winners': self.winner}
